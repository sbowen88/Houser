...
import { updateAddress, updateCity, updateState, updateZip, cancel } from '../Ducks/Reducer';
        ...
        <div className="Wizard__router_container">
          ...
          <div className="Wizard__step_container">
            ...
            <div className="Wizard__stepHighlight_container">
              <span className="open-sans Wizard__stepHighlight_span" >Step 2</span>
            ...
            <div className="Step__container">
              ...
              <input className="Step__input dark_green_border open-sans" value={this.props.address} onChange={ ( e ) => this.props.updateAddress( e.target.value ) }/>
              ...
              <div className="Step2__middle_container">
                <div className="Step2__city_container">
                  ...
                  <input
                    ...
                    value={this.props.city} onChange={ ( e ) => this.props.updateCity( e.target.value ) }
                  />
                </div>
                <div className="Step2__state_container">
                  ...
                  <input
                    className="open-sans dark_green_border Step__input"
                    value={this.props.State} onChange={ ( e ) => this.props.updateState( e.target.value ) }
                  />
                </div>
              </div>
              ...
              <input className="open-sans dark_green_border Step__input Step2__zip_input" value={this.props.zip} onChange={ ( e ) => this.props.updateZip( e.target.value ) }/>
              </div>
              <div className="Step__btn_container">
                <Link className="Step__btn_next darkest_green_bgc" to="/Wizard1">
                  Previous Step
                </Link>
...
export default connect( mapStateToProps, {updateAddress, updateCity, updateState, updateZip, cancel} )( Wizard2 );
