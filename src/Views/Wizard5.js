        ...
        <div className="Wizard__router_container">
          ...
          <div className="Wizard__step_container">
            ...
            <div className="Wizard__stepHighlight_container">
              <span className="open-sans Wizard__stepHighlight_span">Step 5</span>
            ...
            <div className="Step__container">
                <span className="open-sans-bold Recommended-rent">Recommended Rent: $</span>
              <div className="Step5__name_container">
                <span className="open-sans-bold Step__input_header Step1__name_header">
                  Desired Rent
                </span>
              </div>
              <input className="Step__input dark_green_border open-sans" value={this.props.desiredRent} onChange={ ( e ) => this.props.updateDesiredRent( e.target.value ) } />
              <div className="Step__btn_container">
                <Link to='/Wizard4' className="Step__btn_next darkest_green_bgc" >
                  Previous Step
                </Link>
                <Link to ='/Dashboard' className="Step__btn_next lightest_green_bgc" >
                  Complete
                </Link>
              </div>
            </div>
